...
const AddCourse = () => {
      ...
      setChapters(
        chapters.map((chapter) => {
          if (chapter.chapterId === chapterId) {
            const updatedLectures = chapter.chapterContent.filter(
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // Implement course submission logic here
    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 pt-8 pb-0'>
      ...
      >
        ...
        <div>
          ...
          <div
            className='flex items-center justify-center bg-blue-100 p-2 rounded cursor-pointer'
        ...
        <button
          type='submit'
          className='w-max bg-blue-400 text-white px-8 py-2.5 rounded cursor-pointer'
        >
          ADD
        </button>
      </form>
